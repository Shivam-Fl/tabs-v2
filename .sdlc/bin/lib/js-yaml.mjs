...
// Vendored verbatim from js-yaml 5.4.2 dist/js-yaml.mjs (MIT, (C) 2011-2015 Vitaly Puzrin) so the framework never resolves a dependency from the product tree.
//#region src/tag.ts
/**
